...
class SubSubCategoriesController extends Controller
{
    ...
    {
        if ($request->ajax()){
            $items = SubSubCategory::latest()->get();
            return DataTables::of($items)->make(true);
        }
        return view('admin.categories.subSubCategories.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.categories.subSubCategories.edit', compact('item'));
    }
    ...
    {
        $item = SubSubCategory::findorfail($id)->delete();
    ...
    public function supSupCategoryID(Request $request){
        $states =  SubSubCategory::where('sub_category_id',$request->sup_category_id)->pluck("name_en","id");
