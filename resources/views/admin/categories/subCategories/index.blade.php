...
@section('pageName',trans('web.subCategories'))
@section('thead')
    <tr>
        <th>{{trans('web.id')}}</th>
        ...
        <th>{{trans('web.subSubCategoriesCount')}}</th>
...
@section('modal')
    @include('admin.categories.subCategories.create',['id'=>'createmodal','name'=>trans('web.createNewSubCategory'),'action'=>url()->current()])
@stop
@endif
        ...
        $(document).ready(function () {
            ...
            var dataListView = $(".data-list-view").DataTable({
                ...
                "columns": [
                    ...
                    {data: 'sub_sub_cat_count', name: 'sub_sub_cat_count'},
