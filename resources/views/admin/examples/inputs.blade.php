                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 col-md-12 col-12">
                                                @include('admin.components.inputs.multiSelect', [
                                                'name' => 'name',
                                                'id' => 'name',
                                                'class' => 'danger',
                                                'value' => 'name',
                                            ...
                                            <div class="col-xl-12 col-md-12 col-12">
                                            @include('admin.components.uploud.file', ['name' =>'image','label'=>'Category Cover','max'=>'5','accept'=>'image/*' , 'disabled' => false, 'value'=>''])
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <p class="form-control-static" id="staticInput">email.com</p>
                                                </fieldset>
                                            </div>
                                        </div>
                                    </div>
