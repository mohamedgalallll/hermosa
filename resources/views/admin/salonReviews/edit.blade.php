...
@section('content')
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            @include('admin.layout.panels.breadcrumb', ['pageName' => trans('web.editSalonReview') .' : '.$item->name ,'items'=>[
            [
            'name'=>trans('web.salonReview'),
                        ...
                        <div class="col-md-6 col-12 mx-auto">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> {{trans('web.editSalonReview') .' '.$item->name}}</h4>
                                </div>
