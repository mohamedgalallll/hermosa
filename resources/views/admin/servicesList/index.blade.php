...
@section('pageName',trans('web.servicesList'))
@section('thead')
    <tr>
        <th>{{trans('web.id')}}</th>
...
@section('modal')
    @include('admin.servicesList.create',['id'=>'createmodal','name'=>trans('web.createNewService'),'action'=>url()->current()])
@stop
@endif
