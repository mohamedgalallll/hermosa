...
@section('modal')
    @include('admin.teams.create',['id'=>'createmodal','name'=>trans('web.createNewTeam'),'action'=>url()->current()])
@stop
@endif
        ...
        $(document).ready(function () {
            ...
            var dataListView = $(".data-list-view").DataTable({
                ...
                buttons: [
                        @if (auth()->User()->group->categories_add == 1)
                    {
                        text: "<i class='feather icon-plus'></i>{{trans('web.addTeamMember')}}",
                        action: function () {
                ...
                "columns": [
                    ...
                    "mRender": function (data, type, row) {
                        return $("<div/>").html(row.review).text();
                    }
                },
