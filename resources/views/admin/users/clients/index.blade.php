...
@section('modal')
    @include('admin.users.clients.create',['id'=>'createmodal','name'=>trans('web.createNewClient'),'action'=>url()->current()])
@stop
@endif
                ...
                "columns": [
                    ...
                    {data: 'name', name: 'name'},
                    {
                        "mRender": function (data, type, row) {
                            return  '<div class="avatar  avatar-xl"><img src="'+row.user_main_image+'" alt="Img placeholder"></div>';
                        }
                    },
