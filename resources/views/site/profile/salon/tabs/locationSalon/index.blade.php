<div class="tab-pane fade" id="{{$id}}" role="tabpanel" aria-labelledby="{{$aria_labelledby}}">
    <form method="post" action="{{url('profile/update-location')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="mb-2 align-header">
                    <i class="fas fa-edit pl-2 pr-2"></i> {{ trans('web.updateSalonLocation') }}
                </div>
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-12">
                        ...
                        'label' =>trans('web.salonLocation'),
                        'icon' =>'fa fa-location-arrow',
                        'placeholder' => trans('web.salonLocation'),
                        'disabled' => false,
                        'required' => true,
                        ])
                        <hr>
                        <div id="salon_location" style="width: 100%; height: 400px;"></div>
                    </div>
                </div>
                <div class="row">
